let m=!1,l=null,C="",b=!1,y=!1,v=!1,L=0,I=0,M=0,_=0,g=0,h=0,s="default";const H=["Academic","Professional","Creative","Technical","Personal"],u={openai:{name:"OpenAI",selectors:["textarea[data-id]",'textarea[placeholder*="message"]','div[contenteditable="true"]',"#prompt-textarea"],waitForLoad:1e3},anthropic:{name:"Anthropic",selectors:['div[contenteditable="true"]',"textarea",'div[role="textbox"]'],waitForLoad:1500},google:{name:"Google",selectors:['textarea[aria-label*="message"]','div[contenteditable="true"]','textarea[placeholder*="Enter a prompt"]'],waitForLoad:2e3},grok:{name:"Grok",selectors:['div[contenteditable="true"]','textarea[placeholder*="Ask Grok"]','div[role="textbox"]','textarea[data-testid*="compose"]'],waitForLoad:2e3},deepseek:{name:"DeepSeek",selectors:['textarea[placeholder*="Send a message"]','div[contenteditable="true"]','textarea[class*="input"]'],waitForLoad:1500},mistral:{name:"Mistral",selectors:['textarea[placeholder*="Type a message"]','div[contenteditable="true"]','textarea[class*="chat"]'],waitForLoad:1500},perplexity:{name:"Perplexity",selectors:['textarea[placeholder*="Ask anything"]','div[contenteditable="true"]'],waitForLoad:1e3},huggingface:{name:"Hugging Face",selectors:['textarea[placeholder*="Type a message"]','div[contenteditable="true"]'],waitForLoad:1500},default:{name:"Generic",selectors:["textarea",'input[type="text"]','div[contenteditable="true"]','div[role="textbox"]'],waitForLoad:500}};function A(){try{console.log("PromptPilot content script initializing..."),X(),ct();const t=u[s]||u.default;setTimeout(()=>{try{K(),R()}catch(e){console.error("Error during delayed initialization:",e)}},t.waitForLoad),chrome.runtime.onMessage.addListener(q),document.addEventListener("mouseup",et),document.addEventListener("mousedown",T),document.addEventListener("focusin",T),F(),console.log(`PromptPilot content script initialized for platform: ${s}`),at(),s!=="default"&&setTimeout(()=>{try{st("platform-detected")}catch(e){console.error("Error showing contextual help:",e)}},5e3)}catch(t){console.error("Error during PromptPilot initialization:",t)}}function X(){const t=window.location.hostname.toLowerCase();t.includes("openai.com")||t.includes("chatgpt.com")?s="openai":t.includes("anthropic.com")||t.includes("claude.ai")?s="anthropic":t.includes("google.com")||t.includes("bard.google.com")||t.includes("gemini.google.com")?s="google":t.includes("grok.com")||t.includes("x.ai")?s="grok":t.includes("deepseek.com")||t.includes("deepseek.ai")?s="deepseek":t.includes("mistral.ai")?s="mistral":t.includes("perplexity.ai")?s="perplexity":t.includes("huggingface.co")?s="huggingface":s="default",console.log(`Detected platform: ${s} (${t})`)}function R(){(u[s]||u.default).selectors.forEach(e=>{try{document.querySelectorAll(e).forEach(n=>{n.hasAttribute("data-promptpilot-tracked")||(n.setAttribute("data-promptpilot-tracked","true"),n.addEventListener("focus",T),n.addEventListener("click",T))})}catch(o){console.warn(`Failed to setup handler for selector ${e}:`,o)}})}function F(){new MutationObserver(e=>{let o=!1;e.forEach(n=>{n.type==="childList"&&n.addedNodes.length>0&&n.addedNodes.forEach(i=>{if(i.nodeType===Node.ELEMENT_NODE){const r=i;r.matches&&(r.matches("textarea")||r.matches('input[type="text"]')||r.matches('div[contenteditable="true"]')||r.matches('div[role="textbox"]'))&&(o=!0),r.querySelector&&(r.querySelector("textarea")||r.querySelector('input[type="text"]')||r.querySelector('div[contenteditable="true"]')||r.querySelector('div[role="textbox"]'))&&(o=!0)}})}),o&&setTimeout(R,500)}).observe(document.body,{childList:!0,subtree:!0})}function q(t,e,o){if(console.log("Content script received message:",t.type),t.type==="IMPROVED_TEXT_FOR_REPLACEMENT")$(t.text,o);else if(t.type==="IMPROVEMENT_ERROR")W(t.error,o);else if(t.type==="USAGE_LIMIT_REACHED")Y(t,o);else if(t.type==="USAGE_WARNING")j(t,o);else if(t.type==="GET_SELECTED_TEXT"){const n=B();console.log("GET_SELECTED_TEXT request received, returning:",n.substring(0,50)+(n.length>50?"...":"")),o({text:n})}return!0}function $(t,e){try{if(console.log("Received improved text for replacement"),!t){p({message:"No improvement suggestions received. Please try again with different text.",type:"warning",icon:"🤔",duration:6e3,dismissible:!0,actionText:"Try Again",actionCallback:()=>{k()}}),f(),m=!1,e({status:"error"});return}Q(t),nt(),chrome.storage.session.set({lastImprovedText:t},()=>{console.log("Saved improved text to session storage")}),e({status:"text_updated"})}catch(o){console.error("Error handling improved text:",o),p({message:"Failed to insert improved text. You can copy it from the popup instead.",type:"error",icon:"📋",duration:8e3,dismissible:!0,actionText:"Open Popup",actionCallback:()=>{chrome.runtime.sendMessage({type:"OPEN_POPUP"})}}),f(),m=!1,e({status:"error"})}}function W(t,e){console.error("Received improvement error:",t);let o=t||"Error improving text",n,i;t.includes("API key")||t.includes("authentication")?(o="API authentication failed. Please check your settings.",n="Open Settings",i=()=>{chrome.runtime.sendMessage({type:"OPEN_OPTIONS_PAGE"})}):t.includes("network")||t.includes("connection")?(o="Network error. Please check your internet connection and try again.",n="Retry",i=()=>{k()}):(t.includes("rate limit")||t.includes("quota"))&&(o="API rate limit reached. Please wait a moment and try again.",n="Learn More",i=()=>{chrome.runtime.sendMessage({type:"OPEN_HELP_PAGE"})}),p({message:o,type:"error",icon:"❌",duration:8e3,dismissible:!0,actionText:n,actionCallback:i}),f(),m=!1,e({status:"error_displayed"})}function Y(t,e){console.log("Usage limit reached:",t);const{remaining:o,limit:n,subscriptionStatus:i}=t;let r=`You've reached your monthly limit of ${n} improvements.`;p(i==="free"?{message:r,type:"error",icon:"🚫",duration:8e3,dismissible:!0,actionText:"Upgrade Now",actionCallback:()=>{chrome.runtime.sendMessage({type:"OPEN_UPGRADE_PAGE"})}}:{message:r+" Please contact support if this seems incorrect.",type:"error",icon:"⚠️",duration:6e3,dismissible:!0}),f(),m=!1,e({status:"limit_displayed"})}function j(t,e){console.log("Usage warning:",t);const{remaining:o,limit:n,subscriptionStatus:i}=t;i==="free"&&(o===1?p({message:"Last improvement remaining! Your usage resets on the 1st of next month.",type:"warning",icon:"🚨",duration:8e3,dismissible:!0,actionText:"Upgrade Now",actionCallback:()=>{chrome.runtime.sendMessage({type:"OPEN_UPGRADE_PAGE"})}}):o===4&&p({message:`${o} improvements left this month. Upgrade for unlimited access!`,type:"warning",icon:"⚠️",duration:6e3,dismissible:!0,actionText:"Learn More",actionCallback:()=>{chrome.runtime.sendMessage({type:"OPEN_UPGRADE_PAGE"})}})),e({status:"warning_displayed"})}function V(){chrome.runtime.sendMessage({type:"GET_REMAINING_IMPROVEMENTS"},t=>{if((t==null?void 0:t.status)==="success"){const e=t.data;e===4?p({message:`${e} improvements left this month. Upgrade for unlimited access!`,type:"warning",icon:"⚠️",duration:6e3,dismissible:!0,actionText:"Learn More",actionCallback:()=>{chrome.runtime.sendMessage({type:"OPEN_UPGRADE_PAGE"})}}):e===1&&p({message:"Last improvement remaining! Your usage resets on the 1st of next month.",type:"warning",icon:"🚨",duration:8e3,dismissible:!0,actionText:"Upgrade Now",actionCallback:()=>{chrome.runtime.sendMessage({type:"OPEN_UPGRADE_PAGE"})}})}})}function Q(t){var n;const e=window.getSelection();if(e&&!e.isCollapsed){const i=e.getRangeAt(0);i.deleteContents(),i.insertNode(document.createTextNode(t));const r=(n=e.anchorNode)==null?void 0:n.parentElement;r&&P(r);return}const o=document.activeElement;o&&N(o,t)||l&&N(l,t)||J(t)||(console.warn("No target element found to insert improved text"),p({message:"Please select text or click in a text field before improving",type:"error",icon:"❌",duration:5e3,dismissible:!0}))}function N(t,e){if(!t)return!1;try{if(t.tagName==="TEXTAREA"||t.tagName==="INPUT"){const o=t,n=o.selectionStart||0,i=o.selectionEnd||0;if(n!==i){const r=o.value;o.value=r.substring(0,n)+e+r.substring(i);try{o.setSelectionRange(n+e.length,n+e.length)}catch(a){console.warn("Error setting selection range:",a)}}else{o.value=e;try{o.setSelectionRange(e.length,e.length)}catch(r){console.warn("Error setting selection range:",r)}}return P(o),!0}else if(t.getAttribute("contenteditable")==="true"){const o=window.getSelection();if(t.focus(),o&&!o.isCollapsed&&o.anchorNode&&t.contains(o.anchorNode)){const n=o.getRangeAt(0);n.deleteContents(),n.insertNode(document.createTextNode(e))}else t.textContent=e;return P(t),!0}}catch(o){console.warn("Error inserting text into element:",o)}return!1}function J(t){const e=u[s]||u.default;for(const o of e.selectors)try{const n=document.querySelectorAll(o);for(const i of n){const r=i;if(D(r)&&N(r,t))return l=r,!0}}catch(n){console.warn(`Error with platform-specific insertion for selector ${o}:`,n)}return!1}function P(t){if(t)try{if([new Event("input",{bubbles:!0}),new Event("change",{bubbles:!0}),new InputEvent("input",{bubbles:!0,inputType:"insertText"}),new Event("blur",{bubbles:!0}),new Event("focus",{bubbles:!0})].forEach(o=>{try{t.dispatchEvent(o)}catch{}}),s==="openai"||s==="anthropic")try{if(t.tagName==="TEXTAREA"||t.tagName==="INPUT"){const o=t;let n=null;try{t.tagName==="TEXTAREA"?n=Object.getOwnPropertyDescriptor(HTMLTextAreaElement.prototype,"value"):n=Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"value"),n||(n=Object.getOwnPropertyDescriptor(t,"value"))}catch(i){console.warn("Error getting property descriptor:",i),n=null}if(n&&typeof n=="object"&&n.set&&typeof n.set=="function")try{const i=o.value;n.set.call(t,i)}catch(i){console.warn("Error calling descriptor setter:",i)}}}catch(o){console.warn("Error triggering React descriptor events:",o)}}catch(e){console.warn("Error triggering input events:",e)}}function K(){const t=document.createElement("div");t.id="promptpilot-container",t.className="promptpilot-container",gt(t);const e=document.createElement("button");e.id="promptpilot-main-button",e.className="promptpilot-main-button",e.innerHTML='<span class="promptpilot-main-icon">✏️</span>',e.title="PromptPilot - Click to expand",e.addEventListener("click",Z);const o=document.createElement("div");o.className="promptpilot-drag-handle",o.title="Drag to move widget",o.innerHTML='<span class="promptpilot-drag-dots">⋮⋮</span>',o.addEventListener("mousedown",mt),document.addEventListener("mousemove",ut),document.addEventListener("mouseup",ft),e.appendChild(o);const n=document.createElement("div");n.id="promptpilot-expanded",n.className="promptpilot-expanded";const i=document.createElement("button");i.className="promptpilot-intent-button",i.innerHTML='<span class="promptpilot-intent-icon">🎯</span>',i.title="Select intent category",i.addEventListener("click",O);const r=document.createElement("div");r.className="promptpilot-intent-dropdown";const a=document.createElement("ul");a.className="promptpilot-intent-list",H.forEach(d=>{const E=document.createElement("li");E.className="promptpilot-intent-item",E.textContent=d,E.addEventListener("click",()=>pt(d)),a.appendChild(E)}),r.appendChild(a);const c=document.createElement("button");c.id="promptpilot-improve-button",c.className="promptpilot-improve-button",c.innerHTML='<span class="promptpilot-improve-icon">⚡</span>',c.title="Improve selected text",c.addEventListener("click",k),n.appendChild(i),n.appendChild(r),n.appendChild(c),t.appendChild(e),t.appendChild(n),document.body.appendChild(t),document.addEventListener("click",dt),window.addEventListener("resize",ht),console.log("PromptPilot minimalistic widget added to page")}function Z(t){if(v)return;t.stopPropagation(),y=!y;const e=document.getElementById("promptpilot-expanded"),o=document.getElementById("promptpilot-main-button");e&&o&&(y?(e.classList.add("expanded"),o.classList.add("expanded")):(e.classList.remove("expanded"),o.classList.remove("expanded"),b&&O(t)))}function O(t){t.stopPropagation(),b=!b;const e=document.querySelector(".promptpilot-intent-dropdown"),o=document.querySelector(".promptpilot-intent-button");e&&o&&(b?(e.classList.add("open"),o.classList.add("active")):(e.classList.remove("open"),o.classList.remove("active")))}function k(){if(m){console.log("Improvement already in progress");return}const t=B();if(!t){p({message:"No text found. Please click or focus on a text field first.",type:"warning",icon:"⚠️",duration:5e3,dismissible:!0,actionText:"Help",actionCallback:()=>{chrome.runtime.sendMessage({type:"OPEN_HELP_PAGE"})}});return}console.log("Improving text:",t.substring(0,50)+(t.length>50?"...":"")),m=!0,ot(),chrome.storage.session.set({lastCapturedText:t},()=>{console.log("Saved text to session storage")}),chrome.runtime.sendMessage({type:"IMPROVE_AND_REPLACE",text:t,intent:C||"General",platform:s},e=>{chrome.runtime.lastError?(console.error("Error sending improvement request:",chrome.runtime.lastError),p({message:"Extension communication failed. Please refresh the page and try again.",type:"error",icon:"🔄",duration:8e3,dismissible:!0,actionText:"Refresh Page",actionCallback:()=>{window.location.reload()}}),f(),m=!1):(console.log("Background script response:",e),e&&e.status==="processing"?(console.log("Background script is processing the request"),setTimeout(()=>{m&&(console.warn("Improvement timeout - resetting state"),p({message:"Request timed out. Please try again.",type:"warning",icon:"⏰",duration:6e3,dismissible:!0,actionText:"Try Again",actionCallback:()=>{k()}}),f(),m=!1)},3e4)):e&&e.status==="limit_reached"?(console.log("Usage limit reached"),f(),m=!1):e&&e.status==="error"?(console.error("Background script returned error:",e.error),p({message:e.error||"Failed to improve prompt. Please try again.",type:"error",icon:"❌",duration:8e3,dismissible:!0}),f(),m=!1):console.log("Unexpected response from background script:",e))})}function B(){var n,i;const t=window.getSelection();if(t&&t.toString().trim()!=="")return t.toString().trim();const e=document.activeElement;if(e){if(e.tagName==="TEXTAREA"||e.tagName==="INPUT"){l=e;const r=e;return r.selectionStart!==void 0&&r.selectionEnd!==void 0&&r.selectionStart!==null&&r.selectionEnd!==null&&r.selectionStart!==r.selectionEnd?r.value.substring(r.selectionStart,r.selectionEnd).trim():r.value.trim()}else if(e.getAttribute("contenteditable")==="true")return l=e,t&&t.toString().trim()!==""?t.toString().trim():((n=e.textContent)==null?void 0:n.trim())||""}const o=tt();if(o)return o;if(l){if(l.tagName==="TEXTAREA"||l.tagName==="INPUT")return l.value.trim();if(l.getAttribute("contenteditable")==="true")return((i=l.textContent)==null?void 0:i.trim())||""}return""}function tt(){var e,o;const t=u[s]||u.default;for(const n of t.selectors)try{const i=document.querySelectorAll(n);for(const r of i){const a=r;if(D(a)&&(a===document.activeElement||a===l)){if(l=a,a.tagName==="TEXTAREA"||a.tagName==="INPUT"){const c=a;if(c.value.trim())return c.value.trim()}else if(a.getAttribute("contenteditable")==="true"){const c=((e=a.textContent)==null?void 0:e.trim())||((o=a.innerText)==null?void 0:o.trim())||"";if(c)return c}}}}catch(i){console.warn(`Error with selector ${n}:`,i)}return""}function D(t){if(!t)return!1;const e=window.getComputedStyle(t);if(e.display==="none"||e.visibility==="hidden"||e.opacity==="0")return!1;const o=t.getBoundingClientRect();return!(o.width===0||o.height===0)}function et(t){var o;const e=window.getSelection();if(e&&e.toString().trim()!==""){const n=(o=e.anchorNode)==null?void 0:o.parentElement;n&&(n.tagName==="TEXTAREA"||n.tagName==="INPUT"||n.getAttribute("contenteditable")==="true")&&(l=n)}}function ot(){const t=document.getElementById("promptpilot-improve-button");t&&(t.className="promptpilot-improve-button loading",t.innerHTML='<span class="promptpilot-loader"></span>',t.title="Improving text...")}function f(){const t=document.getElementById("promptpilot-improve-button");t&&(t.className="promptpilot-improve-button",t.innerHTML='<span class="promptpilot-improve-icon">⚡</span>',t.title="Improve selected text")}function nt(){const t=document.getElementById("promptpilot-improve-button");t&&(t.className="promptpilot-improve-button success",t.innerHTML='<span class="promptpilot-improve-icon">✓</span>',t.title="Text improved successfully!",p({message:"Text successfully improved!",type:"success",icon:"✅",duration:3e3,dismissible:!1}),V(),setTimeout(()=>{f(),m=!1},2e3))}let S=[],x=[];const U=3;function it(){if(S.length===0||x.length>=U)return;const t=S.shift();if(t){const e=z(t);x.push(e);const o=t.duration??4e3;o>0&&setTimeout(()=>{w(e)},o)}}function z(t){const e=document.createElement("div");e.className=`promptpilot-notification ${t.type}`;const o=document.createElement("div");if(o.className="promptpilot-notification-content",t.icon){const i=document.createElement("div");i.className="promptpilot-notification-icon",i.textContent=t.icon,o.appendChild(i)}const n=document.createElement("div");if(n.className="promptpilot-notification-message",n.textContent=t.message,o.appendChild(n),e.appendChild(o),t.actionText&&t.actionCallback){const i=document.createElement("button");i.className="promptpilot-notification-action",i.textContent=t.actionText,i.onclick=r=>{r.stopPropagation(),t.actionCallback(),w(e)},e.appendChild(i)}if(t.dismissible){const i=document.createElement("button");i.className="promptpilot-notification-close",i.innerHTML="×",i.onclick=r=>{r.stopPropagation(),w(e)},e.appendChild(i)}return document.body.appendChild(e),e}function w(t){rt(t);const e=x.indexOf(t);e>-1&&(x.splice(e,1),setTimeout(it,100))}function p(t,e){let o;if(typeof t=="string"?o={message:t,type:e||"info",duration:4e3,dismissible:!1}:o={duration:4e3,dismissible:!1,...t},x.length>=U)return S.push(o),null;const n=z(o);x.push(n);const i=o.duration??4e3;return i>0&&setTimeout(()=>{w(n)},i),n}function rt(t){t.parentNode&&(t.style.animation="promptpilot-fade-out 0.3s cubic-bezier(0.4, 0, 0.2, 1)",setTimeout(()=>{t.parentNode&&document.body.removeChild(t)},300))}function at(){chrome.storage.local.get(["promptpilot_onboarding_shown"],t=>{t.promptpilot_onboarding_shown||setTimeout(()=>{p({message:"Welcome to PromptPilot! Click the floating button to improve any text on this page.",type:"info",icon:"👋",duration:1e4,dismissible:!0,actionText:"Got it!",actionCallback:()=>{chrome.storage.local.set({promptpilot_onboarding_shown:!0})}})},2e3)})}function st(t){const o={"no-text-selected":{message:"💡 Tip: Select text or click in a text field, then use PromptPilot to improve it!",duration:6e3},"first-improvement":{message:"🎯 Pro tip: Use the intent selector (target icon) to get more specific improvements!",duration:8e3},"platform-detected":{message:`✨ PromptPilot is optimized for ${(u[s]||u.default).name}. Start improving your prompts!`,duration:5e3}}[t];o&&p({message:o.message,type:"info",icon:"💡",duration:o.duration,dismissible:!0})}function ct(){const t=document.createElement("style");t.textContent=`
  ...
  `,document.head.appendChild(t)}function T(t){const e=t.target;if(!e)return;if(e.tagName==="TEXTAREA"||e.tagName==="INPUT"||e.getAttribute("contenteditable")==="true"){console.log(`Tracking text element: ${e.tagName} (${s})`),l=e;return}const o=u[s]||u.default;for(const a of o.selectors)try{if(e.matches&&e.matches(a)){console.log(`Tracking platform-specific element: ${a} (${s})`),l=e;return}}catch{}let n=e.parentElement,i=0;const r=5;for(;n&&i<r;){if(n.tagName==="TEXTAREA"||n.tagName==="INPUT"||n.getAttribute("contenteditable")==="true"){console.log(`Tracking parent text element: ${n.tagName} (${s})`),l=n;return}for(const a of o.selectors)try{if(n.matches&&n.matches(a)){console.log(`Tracking platform-specific parent: ${a} (${s})`),l=n;return}}catch{}n=n.parentElement,i++}lt(e)}function lt(t){var e,o,n;switch(s){case"openai":if(t.closest("form")||t.closest('[data-testid*="composer"]')){const r=((e=t.closest("form"))==null?void 0:e.querySelector("textarea"))||((o=t.closest('[data-testid*="composer"]'))==null?void 0:o.querySelector("textarea"));r&&(l=r,console.log("Tracking OpenAI textarea via form/composer"))}break;case"anthropic":if(t.closest('[data-testid*="chat"]')||t.closest(".ProseMirror")){const r=t.closest('[contenteditable="true"]')||t.closest(".ProseMirror");r&&(l=r,console.log("Tracking Anthropic contenteditable via chat container"))}break;case"google":if(t.closest('[data-test-id*="input"]')||t.closest('[role="textbox"]')){const r=t.closest('[role="textbox"]')||t.closest("textarea");r&&(l=r,console.log("Tracking Google textbox via role or test-id"))}break;case"grok":if(t.closest('[data-testid*="compose"]')||t.closest('[role="textbox"]')){const r=t.closest('[role="textbox"]')||t.closest('[contenteditable="true"]');r&&(l=r,console.log("Tracking Grok compose element"))}break;case"deepseek":case"mistral":if(t.closest('[class*="chat"]')||t.closest('[class*="input"]')){const r=t.closest("textarea")||t.closest('[contenteditable="true"]');r&&(l=r,console.log(`Tracking ${s} chat input`))}break;default:const i=((n=t.closest("form"))==null?void 0:n.querySelector('textarea, input[type="text"], [contenteditable="true"]'))||document.querySelector('textarea:focus, input[type="text"]:focus, [contenteditable="true"]:focus');i&&(l=i,console.log("Tracking nearby text input for unknown platform"));break}}function pt(t){C=t,b=!1;const e=document.querySelector(".promptpilot-intent-dropdown"),o=document.querySelector(".promptpilot-intent-button");e&&e.classList.remove("open"),o&&(o.classList.remove("active"),o.innerHTML='<span class="promptpilot-intent-icon">🎯</span><span class="promptpilot-intent-indicator"></span>',o.title=`Intent: ${t}`),console.log("Selected intent:",t)}function dt(t){const e=t.target,o=document.getElementById("promptpilot-container");if(o&&!o.contains(e)){if(y){y=!1;const n=document.getElementById("promptpilot-expanded"),i=document.getElementById("promptpilot-main-button");n&&n.classList.remove("expanded"),i&&i.classList.remove("expanded")}if(b){b=!1;const n=document.querySelector(".promptpilot-intent-dropdown"),i=document.querySelector(".promptpilot-intent-button");n&&n.classList.remove("open"),i&&i.classList.remove("active")}}}function mt(t){t.preventDefault(),t.stopPropagation();const e=document.getElementById("promptpilot-container");if(!e)return;const o=e.getBoundingClientRect();M=o.left,_=o.top,L=t.clientX,I=t.clientY,v=!0,e.classList.add("dragging")}function ut(t){if(!v)return;t.preventDefault();const e=document.getElementById("promptpilot-container");if(!e)return;g=M+(t.clientX-L),h=_+(t.clientY-I);const o=window.innerWidth,n=window.innerHeight,i=48,r=48;g=Math.max(0,Math.min(g,o-i)),h=Math.max(0,Math.min(h,n-r)),e.style.left=g+"px",e.style.top=h+"px",e.style.right="auto",e.style.bottom="auto"}function ft(t){if(!v)return;const e=document.getElementById("promptpilot-container");e&&(e.classList.remove("dragging"),G(g,h)),v=!1}function G(t,e){try{const o={x:t,y:e};localStorage.setItem("promptpilot-widget-position",JSON.stringify(o))}catch(o){console.warn("Failed to save widget position:",o)}}function gt(t){try{const e=localStorage.getItem("promptpilot-widget-position");if(e){const o=JSON.parse(e),n=window.innerWidth,i=window.innerHeight,r=48,a=48,c=Math.max(0,Math.min(o.x,n-r)),d=Math.max(0,Math.min(o.y,i-a));t.style.left=c+"px",t.style.top=d+"px",t.style.right="auto",t.style.bottom="auto",g=c,h=d}}catch(e){console.warn("Failed to restore widget position:",e)}}function ht(){const t=document.getElementById("promptpilot-container");if(!t||!(t.style.left||t.style.top))return;const o=window.innerWidth,n=window.innerHeight,i=48,r=48,a=t.getBoundingClientRect();let c=a.left,d=a.top;c=Math.max(0,Math.min(c,o-i)),d=Math.max(0,Math.min(d,n-r)),(c!==a.left||d!==a.top)&&(t.style.left=c+"px",t.style.top=d+"px",g=c,h=d,G(c,d))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",A):A();
