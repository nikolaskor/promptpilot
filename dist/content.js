let u=!1,l=null,C="",h=!1,v=!1,y=!1,A=0,I=0,M=0,_=0,f=0,g=0,s="default";const U=["Academic","Professional","Creative","Technical","Personal"],m={openai:{name:"OpenAI",selectors:["textarea[data-id]",'textarea[placeholder*="message"]','div[contenteditable="true"]',"#prompt-textarea"],waitForLoad:1e3},anthropic:{name:"Anthropic",selectors:['div[contenteditable="true"]',"textarea",'div[role="textbox"]'],waitForLoad:1500},google:{name:"Google",selectors:['textarea[aria-label*="message"]','div[contenteditable="true"]','textarea[placeholder*="Enter a prompt"]'],waitForLoad:2e3},grok:{name:"Grok",selectors:['div[contenteditable="true"]','textarea[placeholder*="Ask Grok"]','div[role="textbox"]','textarea[data-testid*="compose"]'],waitForLoad:2e3},deepseek:{name:"DeepSeek",selectors:['textarea[placeholder*="Send a message"]','div[contenteditable="true"]','textarea[class*="input"]'],waitForLoad:1500},mistral:{name:"Mistral",selectors:['textarea[placeholder*="Type a message"]','div[contenteditable="true"]','textarea[class*="chat"]'],waitForLoad:1500},perplexity:{name:"Perplexity",selectors:['textarea[placeholder*="Ask anything"]','div[contenteditable="true"]'],waitForLoad:1e3},huggingface:{name:"Hugging Face",selectors:['textarea[placeholder*="Type a message"]','div[contenteditable="true"]'],waitForLoad:1500},default:{name:"Generic",selectors:["textarea",'input[type="text"]','div[contenteditable="true"]','div[role="textbox"]'],waitForLoad:500}};function L(){console.log("PromptPilot content script initializing..."),X(),ct();const t=m[s]||m.default;setTimeout(()=>{K(),O()},t.waitForLoad),chrome.runtime.onMessage.addListener(q),document.addEventListener("mouseup",et),document.addEventListener("mousedown",k),document.addEventListener("focusin",k),F(),console.log(`PromptPilot content script initialized for platform: ${s}`),at(),s!=="default"&&setTimeout(()=>{st("platform-detected")},5e3)}function X(){const t=window.location.hostname.toLowerCase();t.includes("openai.com")||t.includes("chatgpt.com")?s="openai":t.includes("anthropic.com")||t.includes("claude.ai")?s="anthropic":t.includes("google.com")||t.includes("bard.google.com")||t.includes("gemini.google.com")?s="google":t.includes("grok.com")||t.includes("x.ai")?s="grok":t.includes("deepseek.com")||t.includes("deepseek.ai")?s="deepseek":t.includes("mistral.ai")?s="mistral":t.includes("perplexity.ai")?s="perplexity":t.includes("huggingface.co")?s="huggingface":s="default",console.log(`Detected platform: ${s} (${t})`)}function O(){(m[s]||m.default).selectors.forEach(e=>{try{document.querySelectorAll(e).forEach(n=>{n.hasAttribute("data-promptpilot-tracked")||(n.setAttribute("data-promptpilot-tracked","true"),n.addEventListener("focus",k),n.addEventListener("click",k))})}catch(o){console.warn(`Failed to setup handler for selector ${e}:`,o)}})}function F(){new MutationObserver(e=>{let o=!1;e.forEach(n=>{n.type==="childList"&&n.addedNodes.length>0&&n.addedNodes.forEach(r=>{if(r.nodeType===Node.ELEMENT_NODE){const i=r;i.matches&&(i.matches("textarea")||i.matches('input[type="text"]')||i.matches('div[contenteditable="true"]')||i.matches('div[role="textbox"]'))&&(o=!0),i.querySelector&&(i.querySelector("textarea")||i.querySelector('input[type="text"]')||i.querySelector('div[contenteditable="true"]')||i.querySelector('div[role="textbox"]'))&&(o=!0)}})}),o&&setTimeout(O,500)}).observe(document.body,{childList:!0,subtree:!0})}function q(t,e,o){if(console.log("Content script received message:",t.type),t.type==="IMPROVED_TEXT_FOR_REPLACEMENT")$(t.text,o);else if(t.type==="IMPROVEMENT_ERROR")W(t.error,o);else if(t.type==="USAGE_LIMIT_REACHED")Y(t,o);else if(t.type==="USAGE_WARNING")j(t,o);else if(t.type==="GET_SELECTED_TEXT"){const n=B();console.log("GET_SELECTED_TEXT request received, returning:",n.substring(0,50)+(n.length>50?"...":"")),o({text:n})}return!0}function $(t,e){try{if(console.log("Received improved text for replacement"),!t){p({message:"No improvement suggestions received. Please try again with different text.",type:"warning",icon:"🤔",duration:6e3,dismissible:!0,actionText:"Try Again",actionCallback:()=>{S()}}),b(),u=!1,e({status:"error"});return}Q(t),nt(),chrome.storage.session.set({lastImprovedText:t},()=>{console.log("Saved improved text to session storage")}),e({status:"text_updated"})}catch(o){console.error("Error handling improved text:",o),p({message:"Failed to insert improved text. You can copy it from the popup instead.",type:"error",icon:"📋",duration:8e3,dismissible:!0,actionText:"Open Popup",actionCallback:()=>{chrome.runtime.sendMessage({type:"OPEN_POPUP"})}}),b(),u=!1,e({status:"error"})}}function W(t,e){console.error("Received improvement error:",t);let o=t||"Error improving text",n,r;t.includes("API key")||t.includes("authentication")?(o="API authentication failed. Please check your settings.",n="Open Settings",r=()=>{chrome.runtime.sendMessage({type:"OPEN_OPTIONS_PAGE"})}):t.includes("network")||t.includes("connection")?(o="Network error. Please check your internet connection and try again.",n="Retry",r=()=>{S()}):(t.includes("rate limit")||t.includes("quota"))&&(o="API rate limit reached. Please wait a moment and try again.",n="Learn More",r=()=>{chrome.runtime.sendMessage({type:"OPEN_HELP_PAGE"})}),p({message:o,type:"error",icon:"❌",duration:8e3,dismissible:!0,actionText:n,actionCallback:r}),b(),u=!1,e({status:"error_displayed"})}function Y(t,e){console.log("Usage limit reached:",t);const{remaining:o,limit:n,subscriptionStatus:r}=t;let i=`You've reached your monthly limit of ${n} improvements.`;p(r==="free"?{message:i,type:"error",icon:"🚫",duration:8e3,dismissible:!0,actionText:"Upgrade Now",actionCallback:()=>{chrome.runtime.sendMessage({type:"OPEN_UPGRADE_PAGE"})}}:{message:i+" Please contact support if this seems incorrect.",type:"error",icon:"⚠️",duration:6e3,dismissible:!0}),b(),u=!1,e({status:"limit_displayed"})}function j(t,e){console.log("Usage warning:",t);const{remaining:o,limit:n,subscriptionStatus:r}=t;r==="free"&&(o===1?p({message:"Last improvement remaining! Your usage resets on the 1st of next month.",type:"warning",icon:"🚨",duration:8e3,dismissible:!0,actionText:"Upgrade Now",actionCallback:()=>{chrome.runtime.sendMessage({type:"OPEN_UPGRADE_PAGE"})}}):o===4&&p({message:`${o} improvements left this month. Upgrade for unlimited access!`,type:"warning",icon:"⚠️",duration:6e3,dismissible:!0,actionText:"Learn More",actionCallback:()=>{chrome.runtime.sendMessage({type:"OPEN_UPGRADE_PAGE"})}})),e({status:"warning_displayed"})}function V(){chrome.runtime.sendMessage({type:"GET_REMAINING_IMPROVEMENTS"},t=>{if((t==null?void 0:t.status)==="success"){const e=t.data;e===4?p({message:`${e} improvements left this month. Upgrade for unlimited access!`,type:"warning",icon:"⚠️",duration:6e3,dismissible:!0,actionText:"Learn More",actionCallback:()=>{chrome.runtime.sendMessage({type:"OPEN_UPGRADE_PAGE"})}}):e===1&&p({message:"Last improvement remaining! Your usage resets on the 1st of next month.",type:"warning",icon:"🚨",duration:8e3,dismissible:!0,actionText:"Upgrade Now",actionCallback:()=>{chrome.runtime.sendMessage({type:"OPEN_UPGRADE_PAGE"})}})}})}function Q(t){var n;const e=window.getSelection();if(e&&!e.isCollapsed){const r=e.getRangeAt(0);r.deleteContents(),r.insertNode(document.createTextNode(t));const i=(n=e.anchorNode)==null?void 0:n.parentElement;i&&N(i);return}const o=document.activeElement;o&&T(o,t)||l&&T(l,t)||J(t)||(console.warn("No target element found to insert improved text"),p({message:"Please select text or click in a text field before improving",type:"error",icon:"❌",duration:5e3,dismissible:!0}))}function T(t,e){if(!t)return!1;try{if(t.tagName==="TEXTAREA"||t.tagName==="INPUT"){const o=t,n=o.selectionStart||0,r=o.selectionEnd||0;if(n!==r){const i=o.value;o.value=i.substring(0,n)+e+i.substring(r),o.setSelectionRange(n+e.length,n+e.length)}else o.value=e,o.setSelectionRange(e.length,e.length);return N(o),!0}else if(t.getAttribute("contenteditable")==="true"){const o=window.getSelection();if(t.focus(),o&&!o.isCollapsed&&o.anchorNode&&t.contains(o.anchorNode)){const n=o.getRangeAt(0);n.deleteContents(),n.insertNode(document.createTextNode(e))}else t.textContent=e;return N(t),!0}}catch(o){console.warn("Error inserting text into element:",o)}return!1}function J(t){const e=m[s]||m.default;for(const o of e.selectors)try{const n=document.querySelectorAll(o);for(const r of n){const i=r;if(D(i)&&T(i,t))return l=i,!0}}catch(n){console.warn(`Error with platform-specific insertion for selector ${o}:`,n)}return!1}function N(t){if(t)try{if([new Event("input",{bubbles:!0}),new Event("change",{bubbles:!0}),new InputEvent("input",{bubbles:!0,inputType:"insertText"}),new Event("blur",{bubbles:!0}),new Event("focus",{bubbles:!0})].forEach(o=>{try{t.dispatchEvent(o)}catch{}}),s==="openai"||s==="anthropic"){const o=Object.getOwnPropertyDescriptor(t,"value")||Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"value")||Object.getOwnPropertyDescriptor(HTMLTextAreaElement.prototype,"value");o&&o.set&&o.set.call(t,t.value)}}catch(e){console.warn("Error triggering input events:",e)}}function K(){const t=document.createElement("div");t.id="promptpilot-container",t.className="promptpilot-container",gt(t);const e=document.createElement("button");e.id="promptpilot-main-button",e.className="promptpilot-main-button",e.innerHTML='<span class="promptpilot-main-icon">✏️</span>',e.title="PromptPilot - Click to expand",e.addEventListener("click",Z);const o=document.createElement("div");o.className="promptpilot-drag-handle",o.title="Drag to move widget",o.innerHTML='<span class="promptpilot-drag-dots">⋮⋮</span>',o.addEventListener("mousedown",mt),document.addEventListener("mousemove",ut),document.addEventListener("mouseup",ft),e.appendChild(o);const n=document.createElement("div");n.id="promptpilot-expanded",n.className="promptpilot-expanded";const r=document.createElement("button");r.className="promptpilot-intent-button",r.innerHTML='<span class="promptpilot-intent-icon">🎯</span>',r.title="Select intent category",r.addEventListener("click",R);const i=document.createElement("div");i.className="promptpilot-intent-dropdown";const a=document.createElement("ul");a.className="promptpilot-intent-list",U.forEach(d=>{const E=document.createElement("li");E.className="promptpilot-intent-item",E.textContent=d,E.addEventListener("click",()=>pt(d)),a.appendChild(E)}),i.appendChild(a);const c=document.createElement("button");c.id="promptpilot-improve-button",c.className="promptpilot-improve-button",c.innerHTML='<span class="promptpilot-improve-icon">⚡</span>',c.title="Improve selected text",c.addEventListener("click",S),n.appendChild(r),n.appendChild(i),n.appendChild(c),t.appendChild(e),t.appendChild(n),document.body.appendChild(t),document.addEventListener("click",dt),window.addEventListener("resize",ht),console.log("PromptPilot minimalistic widget added to page")}function Z(t){if(y)return;t.stopPropagation(),v=!v;const e=document.getElementById("promptpilot-expanded"),o=document.getElementById("promptpilot-main-button");e&&o&&(v?(e.classList.add("expanded"),o.classList.add("expanded")):(e.classList.remove("expanded"),o.classList.remove("expanded"),h&&R(t)))}function R(t){t.stopPropagation(),h=!h;const e=document.querySelector(".promptpilot-intent-dropdown"),o=document.querySelector(".promptpilot-intent-button");e&&o&&(h?(e.classList.add("open"),o.classList.add("active")):(e.classList.remove("open"),o.classList.remove("active")))}function S(){if(u){console.log("Improvement already in progress");return}const t=B();if(!t){p({message:"No text found. Please click or focus on a text field first.",type:"warning",icon:"⚠️",duration:5e3,dismissible:!0,actionText:"Help",actionCallback:()=>{chrome.runtime.sendMessage({type:"OPEN_HELP_PAGE"})}});return}console.log("Improving text:",t.substring(0,50)+(t.length>50?"...":"")),u=!0,ot(),chrome.storage.session.set({lastCapturedText:t},()=>{console.log("Saved text to session storage")}),chrome.runtime.sendMessage({type:"IMPROVE_AND_REPLACE",text:t,intent:C||"General",platform:s},e=>{chrome.runtime.lastError&&(console.error("Error sending improvement request:",chrome.runtime.lastError),p({message:"Extension communication failed. Please refresh the page and try again.",type:"error",icon:"🔄",duration:8e3,dismissible:!0,actionText:"Refresh Page",actionCallback:()=>{window.location.reload()}}),b(),u=!1)})}function B(){var n,r;const t=window.getSelection();if(t&&t.toString().trim()!=="")return t.toString().trim();const e=document.activeElement;if(e){if(e.tagName==="TEXTAREA"||e.tagName==="INPUT"){l=e;const i=e;return i.selectionStart!==void 0&&i.selectionEnd!==void 0&&i.selectionStart!==null&&i.selectionEnd!==null&&i.selectionStart!==i.selectionEnd?i.value.substring(i.selectionStart,i.selectionEnd).trim():i.value.trim()}else if(e.getAttribute("contenteditable")==="true")return l=e,t&&t.toString().trim()!==""?t.toString().trim():((n=e.textContent)==null?void 0:n.trim())||""}const o=tt();if(o)return o;if(l){if(l.tagName==="TEXTAREA"||l.tagName==="INPUT")return l.value.trim();if(l.getAttribute("contenteditable")==="true")return((r=l.textContent)==null?void 0:r.trim())||""}return""}function tt(){var e,o;const t=m[s]||m.default;for(const n of t.selectors)try{const r=document.querySelectorAll(n);for(const i of r){const a=i;if(D(a)&&(a===document.activeElement||a===l)){if(l=a,a.tagName==="TEXTAREA"||a.tagName==="INPUT"){const c=a;if(c.value.trim())return c.value.trim()}else if(a.getAttribute("contenteditable")==="true"){const c=((e=a.textContent)==null?void 0:e.trim())||((o=a.innerText)==null?void 0:o.trim())||"";if(c)return c}}}}catch(r){console.warn(`Error with selector ${n}:`,r)}return""}function D(t){if(!t)return!1;const e=window.getComputedStyle(t);if(e.display==="none"||e.visibility==="hidden"||e.opacity==="0")return!1;const o=t.getBoundingClientRect();return!(o.width===0||o.height===0)}function et(t){var o;const e=window.getSelection();if(e&&e.toString().trim()!==""){const n=(o=e.anchorNode)==null?void 0:o.parentElement;n&&(n.tagName==="TEXTAREA"||n.tagName==="INPUT"||n.getAttribute("contenteditable")==="true")&&(l=n)}}function ot(){const t=document.getElementById("promptpilot-improve-button");t&&(t.className="promptpilot-improve-button loading",t.innerHTML='<span class="promptpilot-loader"></span>',t.title="Improving text...")}function b(){const t=document.getElementById("promptpilot-improve-button");t&&(t.className="promptpilot-improve-button",t.innerHTML='<span class="promptpilot-improve-icon">⚡</span>',t.title="Improve selected text")}function nt(){const t=document.getElementById("promptpilot-improve-button");t&&(t.className="promptpilot-improve-button success",t.innerHTML='<span class="promptpilot-improve-icon">✓</span>',t.title="Text improved successfully!",p({message:"Text successfully improved!",type:"success",icon:"✅",duration:3e3,dismissible:!1}),V(),setTimeout(()=>{b(),u=!1},2e3))}let P=[],x=[];const G=3;function it(){if(P.length===0||x.length>=G)return;const t=P.shift();if(t){const e=z(t);x.push(e);const o=t.duration??4e3;o>0&&setTimeout(()=>{w(e)},o)}}function z(t){const e=document.createElement("div");e.className=`promptpilot-notification ${t.type}`;const o=document.createElement("div");if(o.className="promptpilot-notification-content",t.icon){const r=document.createElement("div");r.className="promptpilot-notification-icon",r.textContent=t.icon,o.appendChild(r)}const n=document.createElement("div");if(n.className="promptpilot-notification-message",n.textContent=t.message,o.appendChild(n),e.appendChild(o),t.actionText&&t.actionCallback){const r=document.createElement("button");r.className="promptpilot-notification-action",r.textContent=t.actionText,r.onclick=i=>{i.stopPropagation(),t.actionCallback(),w(e)},e.appendChild(r)}if(t.dismissible){const r=document.createElement("button");r.className="promptpilot-notification-close",r.innerHTML="×",r.onclick=i=>{i.stopPropagation(),w(e)},e.appendChild(r)}return document.body.appendChild(e),e}function w(t){rt(t);const e=x.indexOf(t);e>-1&&(x.splice(e,1),setTimeout(it,100))}function p(t,e){let o;if(typeof t=="string"?o={message:t,type:e||"info",duration:4e3,dismissible:!1}:o={duration:4e3,dismissible:!1,...t},x.length>=G)return P.push(o),null;const n=z(o);x.push(n);const r=o.duration??4e3;return r>0&&setTimeout(()=>{w(n)},r),n}function rt(t){t.parentNode&&(t.style.animation="promptpilot-fade-out 0.3s cubic-bezier(0.4, 0, 0.2, 1)",setTimeout(()=>{t.parentNode&&document.body.removeChild(t)},300))}function at(){chrome.storage.local.get(["promptpilot_onboarding_shown"],t=>{t.promptpilot_onboarding_shown||setTimeout(()=>{p({message:"Welcome to PromptPilot! Click the floating button to improve any text on this page.",type:"info",icon:"👋",duration:1e4,dismissible:!0,actionText:"Got it!",actionCallback:()=>{chrome.storage.local.set({promptpilot_onboarding_shown:!0})}})},2e3)})}function st(t){const o={"no-text-selected":{message:"💡 Tip: Select text or click in a text field, then use PromptPilot to improve it!",duration:6e3},"first-improvement":{message:"🎯 Pro tip: Use the intent selector (target icon) to get more specific improvements!",duration:8e3},"platform-detected":{message:`✨ PromptPilot is optimized for ${m[s].name}. Start improving your prompts!`,duration:5e3}}[t];o&&p({message:o.message,type:"info",icon:"💡",duration:o.duration,dismissible:!0})}function ct(){const t=document.createElement("style");t.textContent=`
